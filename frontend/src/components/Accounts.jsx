         ...
         <div className="card bg-base-100 shadow-xl border border-base-200 sticky top-0">
            <div className="card-body">
               <h3 className="card-title text-lg font-black uppercase mb-4 flex items-center gap-2">
                   <CreditCard className="w-6 h-6 text-secondary" /> Open Account
               </h3>
               <form onSubmit={handleCreateAccount} className="flex flex-col gap-4">
                  ...
                  <button type="submit" className="btn btn-secondary w-full mt-4 font-black tracking-widest">Open Account</button>
               </form>
            </div>
         </div>
      </div>
         ...
         <div className="card bg-base-100 shadow-xl border border-base-200 h-full">
            <div className="card-body p-0">
               <div className="p-4 border-b border-base-200 flex items-center justify-between bg-base-200/30">
                  <h2 className="card-title text-base font-black uppercase tracking-tight">Account Registry</h2>
                  <div className="badge badge-secondary badge-outline">{accounts.length} Active</div>
               </div>
               <div className="overflow-x-auto">
                  <table className="table table-zebra w-full">
                     ...
                     <tbody>
                        {accounts.map(a => (
                          <tr key={a.account_id}>
                             <th className="font-mono text-secondary">#{a.account_id}</th>
